              ...
              <article class="p-6 bg-white rounded-lg border border-black-200 shadow-md dark:bg-gray-800 dark:border-gray-700 w-screen">
                  <div class="flex justify-between items-center mb-5 text-gray-500">
                      <span class="bg-primary-100 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800">
                          ...
                          {question?.int_category_question_mapping?.int_category?.category_name}
                      </span>
                      <span class="text-sm">{formateDateTime(question?.added_timestamp)}</span>
                  </div>
                  <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white" dangerouslySetInnerHTML={{__html : question?.question_text}}></h2>
                  <p class="mb-5 font-light text-gray-500 dark:text-gray-400" dangerouslySetInnerHTML={{__html : question?.answer_text}}></p>
